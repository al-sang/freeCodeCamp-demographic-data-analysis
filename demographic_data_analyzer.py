...
def calculate_demographic_data(print_data=True):
    ...
    percentage_bachelors = (
        df.loc[df['education'] == 'Bachelors'].shape[0] / total) * 100
    ...
    high = '>50K'
    higher_education_rich = higher_education.query('salary == @high')
    lower_education_rich = lower_education.query('salary == @high')
